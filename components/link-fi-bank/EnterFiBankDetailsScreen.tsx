...
//   return (
//     <View>
//       <Text>EnterPhBankDetailsScreen</Text>
//     </View>
//   );
// };
...
interface EnterFiBankDetailsScreenProps {
  setStep: (step: number) => void;
}
...
const EnterFiBankDetailsScreen: React.FC<EnterFiBankDetailsScreenProps> = ({
  setStep,
}) => {
...
export default EnterFiBankDetailsScreen;
