...
const CodeBiometryScreen = () => {
  ...
  return (
    <Container>
      <ItemContainer>
        <LabelContainer>
          <ItemLabel>PIN Code</ItemLabel>
        </LabelContainer>
        <TouchableOpacity>
          <ItemsWrapper>
            <Item>
              <ItemIcon>
                <Entypo name="lock" size={30} color="#35166e" />
              </ItemIcon>
              <ItemText>Change personal code</ItemText>
            </Item>
            <ItemIcon>
              <Entypo
      ...
      <ItemContainer>
        <LabelContainer>
          <ItemLabel>Biometry</ItemLabel>
        </LabelContainer>
        <TouchableOpacity>
          <ItemsWrapper>
            <Item>
              <ItemIcon>
                <Ionicons name="finger-print-sharp" size={30} color="#35166e" />
              </ItemIcon>
              <ItemText>Log in with biometrics</ItemText>
            </Item>
            <SwitchIcon>
              {/* <Entypo
                name="chevron-with-circle-right"
      ...
      <AddAccountButtonContainer>
        <TouchableOpacity>
          <AddAccountButton>Add eWallet</AddAccountButton>
        </TouchableOpacity>
      </AddAccountButtonContainer>
    </Container>
  );
